  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
        <form role="form" action="bgupdatehandler.php" method="post" enctype="multipart/form-data">
          <?php
          $newid=$_GET['blog'];
          ...
          <h1>Blog Update</h1>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="Enter Title" value="<?php echo $final['name'] ?>" name="name">
                </div>
                <div class="form-group">
